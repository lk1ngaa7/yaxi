															...
															<div class="Lktemp" >
															   <div class="form-group center">
																...
																<div class="form-group center">
																	  ...
																	  <div class="controls">
																		<div class="textarea">
																			  <textarea type="" class="" rows="5" cols="30" placeholder="" name="message[item]"> </textarea>
																		</div>
																	  </div>
																</div>
																<div class="form-group center">
																...
																<div class="form-group center">
																        <label class="control-label">文件动作（教师）</label>
																			  <div class="controls">
																				...
																				<label class="radio inline">
																				  <input type="radio" value="upload" id="uploadAtDetail" name="fileAction[t]">
																				  在详情页面上传
																				</label>
...
<script type="text/javascript"> 
	$(document).ready(function(){
		$("input[value='no']").click(function(){
		   $('.LknoAction').show(100);
		   $('.LkuploadAtDetail').hide(100);
		});
		$("#uploadAtDetail").click(function(){
		   $('.LknoAction').hide(100);
		   $('.LkuploadAtDetail').show(100);
		});
	    $("#uploadAtDetail_ex").click(function(){
		   $('.LknoAction').hide(100);
		   $('.LkuploadAtDetail').show(100);
		});
	  });
